...
$flats_query = mysqli_query($mysqli, "SELECT flats.*,GROUP_CONCAT(photos.image_name) AS images FROM flats JOIN photos ON flats.id = photos.flat_id GROUP BY flats.id");
                ...
                ?>
                    <div class="apartment-card">
                       <div class="apartment-card__img">
                          <img src="<?= 'http://' . $_SERVER['HTTP_HOST'] ?>/assets/img/apartments/<?= substr($flat['images'], 0, strpos($flat['images'], ',')); ?>" alt="">
                       </div>
